...
public class NumberAnimTextView extends BoldTextView {
    ...
    public void setBigDecimalPattern(String pattern) {
    ...
    private boolean checkNumString(String numberStart, String numberEnd) {
        ...
        String regexDecimal = "-?[1-9]\\d*.\\d*|-?0.\\d*[0-9]\\d*";
